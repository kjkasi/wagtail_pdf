...
> **Статус (2026-09-24):** код, миграция, автоматические тесты и документация реализованы. Осталась ручная проверка с другого физического компьютера в LAN и сохранение HAR/скриншота; автоматический smoke-тест уже использует origin `127.0.0.1` вместо `localhost`.
